setwd('/Users/sunzhongyang/Desktop/IE7275/HW2/')
...
fa.parallel(USJudgeRatings[,-1], n.iter = 100, fa = 'both', show.legend = TRUE)
dev.off()

#question 2
pcJudge <- principal(USJudgeRatings[,-1], nfactors = 1)

#question 3
pcJudge <- principal(USJudgeRatings[,-1], nfactors = 2, rotate = 'varimax')

#question 4
pcJudge <- principal(USJudgeRatings[,-1], nfactors = 1, scores = TRUE)
head(pcglass$scores)

#question 5
png(file = '5.Principal Components Analysis.png', width = 1000, height = 750)
pcJudge <- principal(USJudgeRatings[,-1],, nfactors = 2, rotate = 'promax')
factor.plot(pcJudge, labels = rownames(pcJudge$loadings))
dev.off()